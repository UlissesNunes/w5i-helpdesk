      ...
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-50">
          ...
          <?php
                ...
                $corDot = corPorNivel($c['prioridade_nivel']);
                $labelPrioridade = labelPorNivel($c['prioridade_nivel']);
          ...
          <tr class="<?= $rowClass ?>">
            ...
            <td class="px-5 py-4">
              <div class="flex items-center gap-2">
                <span class="w-2.5 h-2.5 rounded-full flex-shrink-0 <?= $corDot ?>"
                  title="<?= $labelPrioridade ?>"></span>
            ...
            <td class="px-5 py-4">
              <span class="inline-flex items-center px-2.5 py-1 rounded-lg
                               text-xs font-semibold <?= $badgeStatus ?>">
                <?= $c['status'] ?>
              </span>
              <?php if ($c['atrasado']): ?>
            ...
            <td class="px-5 py-4">
              ...
              <div class="flex items-baseline gap-1">
                <span class="text-sm font-semibold <?= $c['atrasado'] ? 'text-red-600' : 'text-gray-700' ?>">
                  <?= $c['tempo_exibir'] ?>
                </span>
                <?php if ($c['atrasado']): ?>
...
?php
    ...
    <div class="sm:hidden divide-y divide-gray-100">
      <?php foreach ($chamados as $c): ?>
      <div
        class="p-4 <?= $c['atrasado'] ? 'bg-red-50/50 border-l-4 border-l-red-400' : 'hover:bg-blue-50/20 transition' ?>">
        <div class="flex items-start justify-between gap-3 mb-2">
          ...
          <span class="inline-flex items-center px-2 py-0.5 rounded-lg
                           text-xs font-semibold <?= $badgeStatus ?> flex-shrink-0">
            <?= $c['status'] ?>
          </span>
        </div>
        <div class="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-400">
          ...
          <span class="flex items-center gap-1">
            <span class="w-2 h-2 rounded-full <?= corPorNivel($c['prioridade_nivel']) ?>"></span>
            <?= htmlspecialchars($c['prioridade']) ?>
          </span>
          <?php if ($c['checkin_at']): ?>
